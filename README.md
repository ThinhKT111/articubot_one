...
rviz2 -d src/articubot_one/config/view_bot.rviz : to run file of simulation
ros2 launch articubot_one rsp.launch.py : to launch the topic 
ros2 run joint_state_publisher_gui joint_state_publisher_gui

colcon build --symlink-install : build the project
